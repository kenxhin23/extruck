...
import 'package:extruck/order/badorder/add_dialog.dart';
...
class RefundList extends StatefulWidget {
  ...
  const RefundList(this.data, this.code, this.qty);
                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      ...
                      //       context: context,
                      //       builder: (context) =>
                      //           AddDialog(widget.qty)).then((value) {
                      //     setState(() {
                      //       refreshList();
                      //       // loadProducts();
                      //     });
                      ...
                      showDialog(
                        ...
                        context: context,
                        builder: (context) => AddDialog(widget.data, widget.code, widget.qty)).then((value) {
                        setState(() {
                          ...
                          if (GlobalVariables.viewImg)
                            Container(
                              ...
                              child: noImage
                                ...
                                : Image.file(File(imgPath + _itemlist[index]['image'])),
