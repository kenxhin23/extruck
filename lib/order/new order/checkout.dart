...
class _CheckoutState extends State<Checkout> {
  ...
  addingTransactionLine() async {
    ...
    if (CartData.pMeth == 'Cheque') {
      ...
      db.addtoCashLog(UserData.id, date, CartData.netAmount, 'CASH IN', 'ORDER', tranNo);
    }
    ...
    ///ADD LOG TO LEDGER
    db.minustoLoadLedger(UserData.id, date.toString(), CartData.itmNo, 'STOCK OUT', tranNo);
    ...
    String msg = 'Your Order #$tranNo has been saved successfully. Continue to print receipt';
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(CustomerData.accountName.toString(),
                  style: TextStyle(
                ...
                // const SizedBox(height: 15),
                Text('${CustomerData.city}, ${CustomerData.province}',
                  style: TextStyle(
                    color: Colors.grey[700],
                    fontSize: 12,
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(context, PageTransition(
            type: PageTransitionType.rightToLeft,
            child: const PaymentMethod())).then((value) {
              setState(() {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(formatCurrencyTot.format(double.parse(CartData.netAmount)),
                style: TextStyle(
                  color: Colors.grey[800],
                  fontSize: 20,
                  fontWeight: FontWeight.w500,
                    ...
                    if (CartData.siNum == '') {
                      ...
                      if (action == DialogAction.yes) {
                        showDialog(
                          ...
                          context: context,
                          builder: (context) => const ProcessingBox('Processing order'));
                        addOrder();
                      } else {}
                    }
                  }
