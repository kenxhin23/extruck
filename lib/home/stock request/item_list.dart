...
import 'package:extruck/home/stock%20request/add_dialog.dart';
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      setState(() {
                        ...
                        CartData.itmAmt =
                            _itemlist[index]['list_price_wtax'];
                        CartData.itmQty = '1';
                        CartData.setCateg =
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(_itemlist[index]['product_name'],
                          ...
                          Container(
                            ...
                            width: 80,
                            // color: Colors.grey,
                            child: Text(formatCurrencyAmt.format(double.parse(_itemlist[index]['list_price_wtax'])),
