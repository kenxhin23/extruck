              ...
              Container(
                ...
                child: Column(
                  children: [
                        ...
                        if (!NetworkData.errorMsgShow) {
                          showDialog(
                            ...
                            builder: (context) => const ConfirmDialog(
                              title: 'Confirmation',
                              description: 'Are you sure you want to update transactions?',
                              buttonText: 'Confirm',
                            ),
                          );
                        } else {
                    ...
                    const Text('Note: Full Sync might take a while. Secure a strong connection.',
